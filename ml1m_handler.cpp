...
int main(int argc, char const *argv[]){
    ...
    desc.add_options()
            ...
            ("rating_path", po::value<string>(&filePath)->default_value("../raw_data/ml-1m/ratings.dat"), "path to original rating file")
            ("o_folder", po::value<string>(&outputFolder)->default_value("../data/ml-1m/"), "path to output folder")
